...
- Upgrade to Boxo [v0.27.3](https://github.com/ipfs/boxo/releases/tag/v0.27.3)
...
- Upgrade quic-go to [v0.49.0](https://github.com/quic-go/quic-go/releases/tag/v0.49.0)
